...
export default function CornerIndex() {
  ...
  return <div className="mg-corners">
    <header className="mg-corner-index-header"><div><p className="ed-kicker">THE CORNER ARCHIVE</p><h1>每一个弯，<br /><em>都有自己的名字。</em></h1></div><div><span className="mg-corner-count">{String(corners.length).padStart(2, '0')}<small>篇弯道档案</small></span><p>这些德语地名，既是赛道的坐标，也是森林、山谷与历史留下的线索。</p><p className="mg-corner-scope">北环沿途共有 43 处地名，其中 17 个弯收录了完整档案；其余地名的沿途故事，见<Link to="/#circuit">首页的赛道地图章节</Link>。</p></div></header>
